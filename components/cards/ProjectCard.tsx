      ...
      <Link href={project.link} className="block group">
        ...
        >
          ...
          <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-0">
            <div className="absolute -inset-[1px] bg-gradient-to-r from-accent/50 to-transparent rounded-2xl z-0 blur-sm" />
          </div>
          ...
          <div className="relative z-10 p-8 md:p-12 flex flex-col md:flex-row gap-8 items-center bg-card rounded-2xl h-full">
            ...
            <div className="w-full md:w-2/5 aspect-[4/3] rounded-xl overflow-hidden bg-background relative border border-border/50">
               {/* Moving Gradient placeholder */}
               <motion.div 
                 className="absolute inset-0 opacity-80"
                 style={{
                   background: "linear-gradient(120deg, var(--color-background) 0%, var(--color-border) 50%, var(--color-background) 100%)",
               ...
               />
               <motion.div
                 className="absolute inset-0 flex items-center justify-center font-mono text-secondary/30 text-sm"
