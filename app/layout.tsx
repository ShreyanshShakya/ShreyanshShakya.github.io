...
export const metadata: Metadata = {
  title: {
    default: "Shreyansh Shakya — AI Engineer & ML Systems Builder",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Shreyansh Shakya — AI Engineer & ML Systems Builder",
      },
    ],
  },
  twitter: {
    ...
    title: "Shreyansh Shakya — AI Engineer & ML Systems Builder",
    description: "AI Engineer building distributed ML infrastructure, agentic AI systems, and research-driven ML applications.",
    images: ["/og-image.png"],
